...
'''
    Bạn lấy tên data ở đây: 
        advertising.csv, pricebyarea.csv BostonHousing.csv
'''
data = loadFile(input("Nhập tên file: "))
myObject = LinearRegresstion(data, 1.5, 64)
myObject.run()
predict = myObject.getDataPredict()[:,-1]
